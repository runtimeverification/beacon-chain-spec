...
pre_keys = { "slot"                        : ('SLOT_CELL'                       , intToken)
           ...
           , "current_crosslinks"          : ('CURRENT_CROSSLINKS_CELL'         , unimplemented)
           , "previous_crosslinks"         : ('PREVIOUS_CROSSLINKS_CELL'        , unimplemented)
           ...
           , "latest_block_header"         : ('LATEST_BLOCK_HEADER_CELL'        , unimplemented)
