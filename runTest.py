...
validatorTerm = labelWithKeyPairs('#Validator' , [ ('pubkey'                       , hexIntToken)
                                                 , ('withdrawal_credentials'       , hashString)
...
crosslinkTerm = labelWithKeyPairs('#Crosslink' , [ ('shard'       , intToken)
                                                 ...
                                                 , ('end_epoch'   , intToken)
                                                 , ('data_root'   , hashString)
                                                 ]
                                 )

blockheaderTerm = labelWithKeyPairs('#BeaconBlockHeader' , [ ('slot'        , intToken)
                                                           , ('parent_root' , hashString)
                                                           , ('state_root'  , hashString)
                                                           , ('body_root'   , hashString)
                                                           , ('signature'   , hexIntToken)
                                                           ]
                                   )

eth1dataTerm = labelWithKeyPairs('#Eth1Data' , [ ('deposit_root'  , hashString)
                                               , ('deposit_count' , intToken)
                                               , ('block_hash'    , hashString)
                                               ]
                                )

attestationDataTerm = labelWithKeyPairs('#AttestationData' , [ ('beacon_block_root' , hashString)
